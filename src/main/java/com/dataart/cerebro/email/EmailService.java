...
//        });
    ...
    public void sendEmailAboutPurchase(Advertisement advertisement, AdvertisementOrder adOrder) {
//        executor.execute(() -> {
...
//        });
    ...
    public void sendEmailAboutSell(Advertisement advertisement, AdvertisementOrder adOrder) {
//        executor.execute(() -> {
