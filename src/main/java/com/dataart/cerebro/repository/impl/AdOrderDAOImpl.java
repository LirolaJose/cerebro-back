...
//
//    @Override
//    public AdvertisementOrder addAdOrder(AdvertisementOrder adOrder, LocalDateTime orderTime, Advertisement advertisement, ContactInfo customerInfo) {
...
//                ContactInfo contactInfoInitial = contactInfoDAO.addContactInfo(customerInfo.getName(), customerInfo.getPhone(),
...
//                    Set<Service> servicesSet = adOrder.getServicesSet();
//
...
//    }
//
//    private AdvertisementOrder getAdOrderById(int id) {
...
//    }
//
//    private AdvertisementOrder createAdOrder(ResultSet resultSet) throws SQLException {
...
//    }
//
//    private void setOrderServices(int orderId, Set<Service> servicesSet, Connection connection) {
//        String sqlInsert = "INSERT INTO  services_of_order (service_id, adorder_id) VALUES (?, ?);";
//        try (PreparedStatement prStatement = connection.prepareStatement(sqlInsert)) {
//            for (Service service : servicesSet) {
//                prStatement.setInt(1, service.getId());
