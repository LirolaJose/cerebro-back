...
//    }
//
//    private Category createCategoryDTO(ResultSet resultSet) throws SQLException {
//        Category category = new Category();
//        Set<Service> servicesSet = serviceDAO.getAllServicesByCategoryId(resultSet.getInt("id"));
